  ...
  return (
    <>
      ...
      <section className="py-14 lg:pt-24 lg:pb-10 rounded-3xl relative top-shape overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-3 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          <div className="flex flex-col lg:max-w-[560px]">
            <motion.div
              ...
              <div className="flex items-center gap-2 text-site mb-3 uppercase text-xs lg:text-sm justify-start">
              ...
              <h2 ref={fadeRef} className="text-left fade-up-stagger text-3xl lg:text-[36px] max-w-[600px] font-medium mb-1 leading-tight text-site">
