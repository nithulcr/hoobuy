  ...
  return (
    <section id="property" className="pb-10 lg:pb-14 relative">
      <div className="max-w-[1400px] mx-auto lg:px-6">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-5 relative">
            ...
            return (
              ...
              >
                ...
                <div className="lg:px-3 py-3">
                  ...
                  <span className="flex items-center gap-2 mt-4 font-medium text-xs lg:text-sm justify-end">
                    View More
                    <svg
                      width="18"
                      height="18"
                      ...
                      className="group-hover:rotate-210 transition-transform duration-300"
                    >
                      <circle
                        cx="11.1884"
                        cy="11.1398"
