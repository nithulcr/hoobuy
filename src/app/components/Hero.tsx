...
const Hero = () => {
    ...
    return (
        <>
            <section className="hero-section  bottom-shape overflow-hidden relative w-full md:min-h-[calc(100vh-150px)] rounded-[16px] flex flex-col justify-center items-center relative mt-[75px] lg:mt-[85px] lg:mt-[120px] pb-14 lg:pb-[70px] pt-14 lg:pt-[70px]">
                <div className="max-w-[1360px]  w-full grid lg:grid-cols-2 gap-5 px-6">
                    <div className="py-6 lg:py-10 flex items-center">
                        <motion.div initial={{ opacity: 0, y: 20 }}
                            ...
                            <h1 ref={fadeRef} className="fade-up-stagger text-4xl  xl:text-[56px] font-semibold mb-1 leading-tight">
