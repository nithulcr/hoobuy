...
const Hero = () => {
    ...
    return (
        <>
            <section className="hero-section  bottom-shape overflow-hidden relative w-full md:min-h-[calc(100vh-150px)] rounded-[16px] flex flex-col justify-center items-center relative mt-[75px] lg:mt-[85px] lg:mt-[115px] ">
                <div className="w-full flex flex-col flex-col-reverse lg:grid lg:grid-cols-5">
                    <div className="py-6 lg:py-10 flex items-center lg:justify-end lg:col-span-2 px-6 lg:pl-[60px] pb-14 lg:pb-[70px] pt-14 lg:pt-[70px]">
                        <motion.div initial={{ opacity: 0, y: 20 }}
                            ...
                            <div className="flex items-center gap-1 mb-3 uppercase text-xs lg:text-sm">
                                <Image src="/favicon.png" alt="Logo" width={30} height={30} className="object-contain" />
                                Get to Know Us
                            </div>
                            <h1 ref={fadeRef} className="fade-up-stagger text-4xl  xl:text-[56px] font-semibold mb-1 leading-tight max-w-[500px]">
                                Sail Into <span className="text-[var(--siteColor2)]">Smart Property</span> Deals

                            </h1>
                            <p className="text-md lg:text-lg font-light max-w-[500px]">Experience luxury living with our premium properties. Enjoy special discounts and priority access for a limited time only.</p>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }}
                        ...
                        <Image
                            ...
                            width={1000}
                            height={1000}
                            className="object-cover h-full w-full object-left min-h-[calc(100vh-140px)] hidden lg:block"
                        />
                        <Image
                            src="/property1.jpg"
                            alt="Business for Success"
                            width={1000}
                            height={1000}
                            className="object-cover h-full w-full object-left  lg:hidden"
                        />
