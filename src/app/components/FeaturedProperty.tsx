                        ...
                        >
                            ...
                            <span className="block relative">
                                ...
                                <div className="absolute top-[10px] right-[10px] flex gap-2">
                                    <span className=" bg-[var(--siteColor)] text-white font-light text-xs rounded-full px-2 py-[2px]">{property.status}</span>
                                    <span className=" bg-[#ffa500] text-white font-light text-xs rounded-full px-2 py-[2px]">{property.range}</span>
                            ...
                            <div className="p-3">
                                ...
                                <div className="grid grid-cols-2 text-xs mt-2">
                                    ...
                                    <div className="flex flex-col">
                                        <span>Listed</span>
                                        <span className="text-site text-sm">{property.listed}</span>
                                    </div>
                                </div>
                                <Link
                                    href={property.link}
