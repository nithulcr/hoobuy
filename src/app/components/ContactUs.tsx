              ...
              <motion.div
                ...
                <li className="flex items-center  gap-4 bg-white rounded-2xl p-6 ">
                  ...
                  <div className="flex flex-col gap-1 ">
                    ...
                    <a href="mailto:hoobuyrealtors@gmail.com" className="text-1 text-sm font-light">hoobuyrealtors@gmail.com</a>
                  </div>
                </li>
                <li className="flex items-center  gap-4 bg-white rounded-2xl p-6 ">
                  <span className="border border-[var(--siteColor)] p-2 rounded-full  w-16 h-16 flex items-center justify-center">
                  ...
                  <div className="flex flex-col gap-1 ">
                    ...
                    <span className="text-1 text-sm font-light">+91 72933 35555</span>
                  </div>
                </li>
                <li className="flex items-center  gap-4 bg-white rounded-2xl p-6 ">
                  <span className="border border-[var(--siteColor)] p-2 rounded-full  w-16 h-16 flex items-center justify-center">
